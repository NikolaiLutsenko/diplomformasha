...
namespace DiplomaWork.Migrations
{
    ...
    partial class DiplomaWorkContextModelSnapshot : ModelSnapshot
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DiplomaWork.Data.Models.Category", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("DiplomaWork.Data.Models.Request", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("DiplomaWork.Data.Models.RequestState", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("DiplomaWork.Data.Models.Role", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("DiplomaWork.Data.Models.Service", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("DiplomaWork.Data.Models.UserService", b =>
                {
                    b.Property<Guid>("UserId")
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("DiplomaWork.Data.User", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("DiplomaWork.Data.Models.Request", b =>
                {
                    b.HasOne("DiplomaWork.Data.User", "CurrentEmployee")
                        .WithMany("Requests")
                        .HasForeignKey("CurrentEmployeeId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("DiplomaWork.Data.Models.Service", "Service")
                        .WithMany("Requests")
            ...
            modelBuilder.Entity("DiplomaWork.Data.Models.RequestState", b =>
                {
                    b.HasOne("DiplomaWork.Data.Models.Request", "Request")
                        .WithMany("States")
                        .HasForeignKey("RequestId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("DiplomaWork.Data.User", "User")
            ...
            modelBuilder.Entity("DiplomaWork.Data.Models.Service", b =>
                {
                    b.HasOne("DiplomaWork.Data.Models.Category", "Category")
                        .WithMany("Services")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRoleClaim<System.Guid>", b =>
                {
                    b.HasOne("DiplomaWork.Data.Models.Role", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<System.Guid>", b =>
                {
                    b.HasOne("DiplomaWork.Data.User", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
